...
export function Dashboard() {
  ...
  const busy = state.core === "orchestrating";
  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden bg-[#0a0d14] text-white">
      ...
      {/* Top-right status — hidden while a node panel is open */}
      {!selected && (
      ...
      {cfg && <Graph cfg={cfg} state={state} onNodeClick={setSelected} />}
